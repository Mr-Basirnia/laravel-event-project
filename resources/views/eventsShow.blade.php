<x-main-layout>
    <div class="m-2 p-2 flex justify-between">
        <h3 class="mb-4 text-2xl font-bold text-slate-50">{{ $event->title }}</h3>
    ...
    <div class="mb-16 flex flex-wrap">
        <div class="mb-6 w-full shrink-0 grow-0 basis-auto lg:mb-0 lg:w-6/12 lg:pr-6">
            <div class="flex flex-col">
                ...
                @auth
                    <div class="flex space-x-2 p-4" x-data="{
                        ...
                        <button type="button" @click="onHandleLike"
                            class="text-white  focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2"
                ...
                <div class="flex flex-col p-4">
                    <span class="text-slate-400 font-semibold">Host Info</span>
        ...
        <div class="w-full shrink-0 grow-0 lg:w-6/12 lg:pl-6 bg-stone-700 dark:bg-slate-800 rounded-md p-2">
